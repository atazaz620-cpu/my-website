              ...
              {editing ? (
                <div className="flex flex-wrap gap-2">
                  {SUBJECTS.map(s => (
                    <button key={s} type="button" onClick={() => toggleSubject(s)}
                      ...
                      style={{
                        background: form.subjects.includes(s) ? '#C9A84C' : '#1e2d47',
                        color: form.subjects.includes(s) ? '#0A0F1C' : '#9EA8B8',
                        border: '1px solid ' + (form.subjects.includes(s) ? '#C9A84C' : '#2a3d5c'),
                      }}>
                      {s}
                    </button>
                  ))}
                ...
                <div className="flex flex-wrap gap-2">
                  {form.subjects.length > 0
                    ? form.subjects.map(s => <span key={s} className="px-2 py-1 rounded text-xs" style={{ background: '#1e2d47', color: '#9EA8B8' }}>{s}</span>)
