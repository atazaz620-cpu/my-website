        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            {[
              ...
              <div key={label} className="card text-center">
                ...
                <p className="font-heading text-2xl font-bold" style={{ color: color || '#F0EBE1' }}>{value}</p>
              </div>
            ))}
          </div>
            ...
            <div className="card mb-6">
              ...
              <ResponsiveContainer width="100%" height={200}>
                <BarChart data={subjectChartData}>
                  <XAxis dataKey="subject" tick={{ fill: '#5A6478', fontSize: 11 }} />
          ...
          <div className="flex flex-wrap items-center gap-3 mb-4">
            <div className="flex gap-2 flex-wrap">
              {subjects.map(s => (
                <button key={s} onClick={() => setFilterSubject(s)}
                  ...
                  style={{
                    background: filterSubject === s ? '#C9A84C' : '#1e2d47',
                    color: filterSubject === s ? '#0A0F1C' : '#9EA8B8',
            ...
            <select value={sortBy} onChange={e => setSortBy(e.target.value as 'date' | 'percentage' | 'subject')}
              ...
              style={{ background: '#1e2d47', color: '#9EA8B8', border: 'none' }}>
