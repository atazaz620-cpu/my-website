          ...
          <div className="card w-full max-w-lg max-h-[90vh] overflow-y-auto" style={{ borderColor: '#C9A84C' }}>
            ...
            <div className="space-y-4">
              ...
              <div
                ...
                style={{ borderColor: selectedFile ? '#C9A84C' : '#1e2d47', background: selectedFile ? 'rgba(184,150,106,0.05)' : 'transparent' }}>
              ...
              {files.map(file => (
                <div key={file.id} className="card group hover:border-border-light transition-all">
                  ...
                  <div className="flex items-center gap-2 flex-wrap mb-3">
                    {file.class && <span className="text-xs px-2 py-0.5 rounded" style={{ background: '#1e2d47', color: '#9EA8B8' }}>{file.class}</span>}
                    {file.board && <span className="text-xs px-2 py-0.5 rounded" style={{ background: '#1e2d47', color: '#9EA8B8' }}>{file.board}</span>}
