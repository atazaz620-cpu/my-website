          ...
          <div className="card w-full max-w-md" style={{ borderColor: '#C9A84C' }}>
            ...
            <div className="space-y-4">
              ...
              {editing.obtainedMarks && editing.totalMarks && (
                <div className="text-center py-2 rounded-lg" style={{ background: '#0A0F1C' }}>
        ...
        <div className="p-6 flex gap-6">
          ...
          <div className="w-72 shrink-0">
            <div className="card p-0 overflow-hidden">
              <div className="p-3" style={{ borderBottom: '1px solid #1e2d47' }}>
                  ...
                  filteredStudents.map(s => (
                    <button key={s.id} onClick={() => setSelectedStudent(s)}
                      ...
                      <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold shrink-0"
                        style={{ background: selectedStudent?.id === s.id ? '#C9A84C' : '#1e2d47', color: selectedStudent?.id === s.id ? '#0A0F1C' : '#9EA8B8' }}>
                        {s.full_name[0]}
                      </div>
                              ...
                              <td>
                                <div className="flex gap-2">
                                  <button onClick={() => openEditForm(m)}
                                    ...
                                    style={{ background: '#1e2d47', color: '#9EA8B8' }}>
                                    Edit
                                  </button>
